  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-12">
        ...
        <div className="flex-1 text-center lg:text-left flex flex-col items-center lg:items-start">
          ...
          <div className="flex flex-col mb-8 select-none items-center lg:items-start">
            ...
            <div className="relative group">
              <h1
                className="text-4xl md:text-5xl font-heading font-black leading-[0.85] tracking-tight uppercase text-white cyber-glitch"
                data-text="S.M."
              >
                S.M.HASAN
              </h1>
            ...
            <h1 className="text-4xl md:text-5xl font-heading font-black leading-[0.85] tracking-tight uppercase bg-linear-to-r from-accent-secondary to-accent-secondary/40 bg-clip-text text-transparent">
              FRONTEND Developer
            </h1>
          ...
          <p className="max-w-md mx-auto lg:ml-0 text-foreground/80 font-mono text-left text-[9px] leading-relaxed mb-10 uppercase tracking-[0.2em]">
            Computer Science Engineering @ DIU (2021-2026). <br />
            Developing high-fidelity UI substrates and scalable web
            architectures.
          </p>
          ...
          <div className="flex items-center justify-center lg:justify-start gap-4">
            <a
              ...
              className="w-10 h-10 border border-white/10 flex items-center justify-center text-lg text-foreground/40 hover:text-accent hover:border-accent hover:neon-glow cyber-chamfer-sm transition-all"
            >
              <FaGithub />
            </a>
            <a
        ...
        <div className="flex-1 relative w-full flex justify-center lg:justify-center group">
          <div className="relative w-full max-w-[450px] aspect-square cyber-chamfer-sm border border-white/5 bg-white/2 p-3 transition-all duration-700 hover:border-accent/40 hover:bg-white/5 hover:shadow-[0_0_50px_rgba(0,255,136,0.1)]">
            ...
            <div className="w-full h-full relative overflow-hidden cyber-chamfer-sm bg-background/80">
               ...
               <div className="w-full h-full relative group-hover:opacity-90">
                  <img 
                    ...
                    alt="S.M.HASAN" 
                    className="w-full h-full object-cover grayscale brightness-90 group-hover:grayscale-0 group-hover:brightness-110 transition-all duration-1000 scale-110 group-hover:scale-100"
                  />
               </div>
               ...
               <div className="absolute top-4 left-4 z-30 flex flex-col gap-1">
                  <span className="text-[7px] font-mono text-accent bg-background/80 px-1 border border-accent/20">UPLINK_SECURE</span>
                  <span className="text-[6px] font-mono text-white/40">SERVICE_RELIABILITY: 99.9%</span>
               </div>

               <div className="absolute bottom-4 right-4 z-30 flex flex-col items-end gap-1 text-right">
                  <span className="text-[7px] font-mono text-accent-secondary bg-background/80 px-1 border border-accent-secondary/20 uppercase tracking-widest">Bio_Verified</span>
                  <span className="text-[6px] font-mono text-white/40 uppercase">Client_Success_Rate: 100%</span>
